...
CKEDITOR.dialog.add('tnqspecialchar', function( editor ) {
                ...
                children: [
                    {
                        type: 'html',
                        html: ([
                            '<div><a title="You will be taken to a page that',
                            ' lists special characters from which you can select',
                            ' one and paste it in PC" href="http://unicode-table.com"',
                            ' target="_blank" style="color:blue;text-',
                            'decoration:underline">For Additional characters click ',
                            'here</a></div>'].join(''))
                    }
                ]
            } ]
