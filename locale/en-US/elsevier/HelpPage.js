define([], function helpLocaleLoader() {
    var locale = {
        ...
        'help.right.panel.interface.right.pane.para.4.controls': 'The right pane has the controls. The topmost lets you address copyeditor Queries. The next control tracks and lists all changes during the proof correction process. The third control may appear when you choose to insert or instruct. Insert option lets you Insert content into the body of the article and Instruct option lets you put in Instructions for your publisher to work on after you submit the proof. The last control tracks and Lists all changes done by the copyeditor and you.',
