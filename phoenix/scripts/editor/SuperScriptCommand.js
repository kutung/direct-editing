define([], function SuperScriptCommandLoader() {
    'use strict';
    ...
    function SuperScriptCommand(genericCommand) {
        ...
        this.genericCommand.createFormatWrapper = function createFormatWrapper() {
            return this.formatConfig.getSuperScriptWrapper();
        };
        ...
        this.genericCommand.hasFormattingParent = function hasFormattingParent(selection) {
            return selection.hasFormattingParentOf('sup');
        };
    ...
    SuperScriptCommand.prototype.execute = function execute() {
