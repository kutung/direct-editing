define([], function ItalicCommandLoader() {
    'use strict';
    ...
    function ItalicCommand(genericCommand) {
        ...
        this.genericCommand.createFormatWrapper = function createFormatWrapper() {
            return this.formatConfig.getItalicWrapper();
        };
        ...
        this.genericCommand.hasFormattingParent = function hasFormattingParent(selection) {
            return selection.hasFormattingParentOf('italic');
        };
        ...
        this.genericCommand.getFormatCssSelector = function getFormatCssSelector() {
            return 'span[data-format-italic="true"]';
        };
        ...
        this.genericCommand.hasUnFormatNode = function hasUnFormatNode(fragment) {
            ...
            while (currentNode !== null) {
                ...
                /* istanbul ignore else */
                    ...
                    else if (this.formatConfig.isItalic(currentNode) === true) {
    ...
    ItalicCommand.prototype.execute = function execute() {
